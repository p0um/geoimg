...
inline void getColorAt(const cv::Mat &img, int row, int col, uint8_t *color) {
...
inline void writeColor(cv::Mat &img, int row, int col, const uint8_t *color, bool dry=false) {
